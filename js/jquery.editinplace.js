...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<button class="btn btn-success inplace_save">Save</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="btn btn-danger inplace_cancel">Cancel</button>', // string: image button tag to use as “Cancel” button
...
$.extend(InlineEditor.prototype, {
	...
	replaceContentWithEditor: function() {
		...
		this.dom.html('<div class="input-append"><form class="inplace_form" style="display: inline; margin: 0; padding: 0;"></form></div>')
			.find('form')
